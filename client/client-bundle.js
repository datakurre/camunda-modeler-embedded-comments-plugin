...
function Comments(eventBus, overlays, bpmnjs, translate) {
  ...
  function createCommentBox(element) {
    var $overlay = jquery__WEBPACK_IMPORTED_MODULE_0___default()(getOverlayHtml(translate));
    ...
    function renderComments() {
      ...
      comments.forEach(function (val) {
        var $comment = jquery__WEBPACK_IMPORTED_MODULE_0___default()(COMMENT_HTML);
...
function getOverlayHtml(translate) {
  return '<div class="comments-overlay">' + '<div class="toggle">' + '<span class="icon-comment"></span>' + '<span class="comment-count" data-comment-count></span>' + '</div>' + '<div class="content">' + '<div class="comments"></div>' + '<div class="edit">' + ("<textarea tabindex=\"1\" placeholder=\"" + translate('Add a comment') + "\"></textarea>") + '</div>' + '</div>' + '</div>';
}
...
(0,camunda_modeler_plugin_helpers__WEBPACK_IMPORTED_MODULE_0__.registerBpmnJSModdleExtension)(documentation);
